...
@click.option('-s', '--setting-file', help='Rubix-Lora: setting json file', default=AppSetting.default_setting_file)
@click.option('-l', '--logging-conf', help='Rubix-Lora: logging config file', default=AppSetting.default_logging_conf)
